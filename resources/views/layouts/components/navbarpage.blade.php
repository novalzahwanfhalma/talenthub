...
<header id="header" class="header fixed-top">
    <div class="container-fluid container-xl d-flex align-items-center justify-content-between">
        ...
        <nav id="navbar" class="navbar">
            <ul>
                <li><a class="nav-link scrollto" href="/LOGIN-DULU-BRO">Lowongan</a></li>
                <li><a class="nav-link scrollto" href="/LOGIN-DULU-BRO">Mahasiswa</a></li>
                ...
                <li class="dropdown"><a href="#"><span>
                    ...
                    <ul>
                        <li><a href="/LOGIN-DULU-BRO">Profil & CV</a></li>
                        <li><a href="/LOGIN-DULU-BRO">Log out</a></li>
                    </ul>
                </li>
            </ul>
