                ...
                <div class="row">
                    ...
                    <div class="col-lg-5">
                        ...
                        <div class="sidebar">
                            ...
                            <h1 class="sidebar-title">Pekerjaan</h1>
                            <h3 class="sidebar-deskripsi">Temukan lowongan yang anda inginkan</h3>
                            <form action="">
                                <div class="p-1 bg-light rounded rounded-pill shadow-sm mb-4">
                                    <div class="input-group">
                                        <input type="search" placeholder="Cari Bidang"
                        ...
                        <div class="container" data-aos="fade-up">
                            ...
                            <div class="row gy-4">
                                ...
                                <div class="col-sm-6 col-md-4 col-lg-4">
                                    <a href="/lowongan2" class="text-decoration-none">
                                        <div class="card rounded-pill"
                                            style="background-color: #e6e6e6; border-width: 3px;">
                                                ...
                                                <div class="d-flex align-items-center">
                                                    ...
                                                    <div class="flex-grow-1 ms-3">
                                                        <div class="d-flex flex-row align-items-center mb-2">
                                                            <p class="mb-0 me-2"
                                                                onmouseover="this.style.color='#60839b'; this.style.fontWeight='normal';"
                                        ...
                                        <div class="card rounded-pill"
                                            ...
                                            <div class="card-body p-2 text-black">
                                                <div class="d-flex align-items-center">
                                                    ...
                                                    <div class="flex-grow-1 ms-3">
                                                        <div class="d-flex flex-row align-items-center mb-2">
                                                            <p class="mb-0 me-2">Bioteknologi</p>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                        ...
                                        <div class="card rounded-pill"
                                            ...
                                            <div class="card-body p-2 text-black">
                                                <div class="d-flex align-items-center">
                                                    ...
                                                    <div class="flex-grow-1 ms-3">
                                                        <div class="d-flex flex-row align-items-center mb-2">
                                                            <p class="mb-0 me-2">Administrasi</p>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                        ...
                                        <div class="card rounded-pill"
                                            ...
                                            <div class="card-body p-2 text-black">
                                                <div class="d-flex align-items-center">
                                                    ...
                                                    <div class="flex-grow-1 ms-3">
                                                        <div class="d-flex flex-row align-items-center mb-2">
                                                            <p class="mb-0 me-2">Jaringan & Infrastuktur</p>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                        ...
                                        <div class="card rounded-pill"
                                            ...
                                            <div class="card-body p-2 text-black">
                                                <div class="d-flex align-items-center">
                                                    ...
                                                    <div class="flex-grow-1 ms-3">
                                                        <div class="d-flex flex-row align-items-center mb-2">
                                                            <p class="mb-0 me-2">Perancangan Elektrikal</p>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                        ...
                                        <div class="card rounded-pill"
                                            ...
                                            <div class="card-body p-2 text-black">
                                                <div class="d-flex align-items-center">
                                                    ...
                                                    <div class="flex-grow-1 ms-3">
                                                        <div class="d-flex flex-row align-items-center mb-2">
                                                            <p class="mb-0 me-2">Sistem Manejemen Data</p>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                        ...
                                        <div class="card rounded-pill"
                                            ...
                                            <div class="card-body p-2 text-black">
                                                <div class="d-flex align-items-center">
                                                    ...
                                                    <div class="flex-grow-1 ms-3">
                                                        <div class="d-flex flex-row align-items-center mb-2">
                                                            <p class="mb-0 me-2">Desain Komunnikasi Visual</p>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                        ...
                                        <div class="card rounded-pill"
                                            ...
                                            <div class="card-body p-2 text-black">
                                                <div class="d-flex align-items-center">
                                                    ...
                                                    <div class="flex-grow-1 ms-3">
                                                        <div class="d-flex flex-row align-items-center mb-2">
                                                            <p class="mb-0 me-2">Perancangan Robot</p>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
